    ...
    internal abstract class BuildPipelineViewerBase
    {
        ...
        private void BuildButton_clicked()
        {
            ...
            if (EditorUtility.DisplayDialog("提示", $"通过构建模式【{buildMode}】来构建！", "Yes", "No"))
            {
                ...
                EditorApplication.delayCall += () => _buildVersionField.value = GetDefaultPackageVersion();
            }
            else
            {
        ...
        {
            int totalMinutes = DateTime.Now.Hour * 3600 + DateTime.Now.Minute * 60 + DateTime.Now.Second;
