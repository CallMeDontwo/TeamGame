...
namespace ET
{
    ...
    {
        [Invoke(InvokeType_Timer.SessionIdleChecker)]
        ...
        {
            self.RepeatedTimer = self.Root().GetComponent<TimerComponent>().NewRepeatedTimer(CheckInteral, InvokeType_Timer.SessionIdleChecker, self);
        }
