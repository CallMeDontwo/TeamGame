    ...
    public static class ShellHelper
    {
        public static void Run(string cmd, string workDirectory, List<string> environmentVars = null)
        {
            ...
            try
            {
                ...
                environmentVars?.Foreach(var => start.EnvironmentVariables["PATH"] += (splitChar + var));
        ...
        public static void Start(string cmd, string workDirectory, List<string> environmentVars = null)
        {
            try
            {
#if UNITY_EDITOR_OSX || UNITY_EDITOR_LINUX
