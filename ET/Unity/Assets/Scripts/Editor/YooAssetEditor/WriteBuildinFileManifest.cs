...
internal class WriteBuildinFileManifest : UnityEditor.Build.IPreprocessBuildWithReport
{
    ...
    public void OnPreprocessBuild(UnityEditor.Build.Reporting.BuildReport report)
    {
        ...
        manifest.BuildTarget = UnityEditor.EditorUserBuildSettings.activeBuildTarget.ToString();
