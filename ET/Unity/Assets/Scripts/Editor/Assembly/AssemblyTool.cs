...
namespace ET
{
    public static class AssemblyTool
    {
        ...
        public static readonly string[] ModelDllNames = { "Unity.Model", "Unity.ModelView" };
        public static readonly string[] HotfixDllNames = { "Unity.Hotfix", "Unity.HotfixView" };
        ...
        /// 菜单和快捷键编译按钮
        /// </summary>
        [MenuItem("ET/Compile _F5", false, ETMenuItemPriority.Compile)]
        ...
        /// 菜单和快捷键热重载按钮
        /// </summary>
        [MenuItem("ET/Reload _F6", false, ETMenuItemPriority.Compile)]
        ...
        static void RefreshCodeMode()
        {
            ...
            CodeMode codeMode = globalConfig ? globalConfig.CodeMode : CodeMode.ClientServer;
        ...
        {
            GlobalConfig globalConfig = Resources.Load<GlobalConfig>("GlobalConfig");
            BuildType buildType = globalConfig ? globalConfig.BuildType : BuildType.Release;
