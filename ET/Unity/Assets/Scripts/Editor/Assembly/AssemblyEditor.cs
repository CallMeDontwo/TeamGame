...
namespace ET
{
    public static class AssemblyEditor
    {
        ...
        static void OnExitingEditMode()
        {
            ...
            if (!globalConfig.SimulateMode || globalConfig.EnableDll)
            {
                DisableDll(AssemblyTool.HotfixDllNames);
            }
            if (!globalConfig.SimulateMode)
            {
                DisableDll(AssemblyTool.ModelDllNames);
            }

            static void DisableDll(string[] dlls)
            {
